...
{
    public partial class GuardarPreguntas : Form
    {
        //Campos
        ...
        private void GuardarPreguntas_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void GuardarPreguntas_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void GuardarPreguntas_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void GuardarPreguntas_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void GuardarPreguntas_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        ...
        private void GuardarPreguntas_Load(object sender, EventArgs e)
        {
            PreguntasFrecuentes preg = new PreguntasFrecuentes();
            cboPreguntas.DataSource = preg.preguntas();
            cboPreguntas.DisplayMember = "pregunta";
            cboPreguntas.ValueMember = "idPreguntas";
        }
