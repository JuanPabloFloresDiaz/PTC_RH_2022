...
namespace PTC_Oficial
{
    public partial class MenuRecepcionista : Form
    {
        ...
        private void MenuRecepcionista_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void MenuRecepcionista_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void MenuRecepcionista_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void MenuRecepcionista_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void MenuRecepcionista_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        ...
        private void MenuRecepcionista_Load(object sender, EventArgs e)
        {
            ...
            btnLlegadasTarde.BackColor = TemaColores.botones;
            btnControlHorario.BackColor = TemaColores.botones;
            btnMenuRec.BackColor = TemaColores.botones;
        ...
        private void btnControlHorario_Click(object sender, EventArgs e)
        {
            ...
            abrirformularios(new ControlHorario());
        }
        ...
        private void btnLlegadasTarde_Click(object sender, EventArgs e)
        {
            resaltarboton(sender, JUPADICOLORS.color2);
            abrirformularios(new LlegadasTarde());
        }

        private void btnMenuRec_Click(object sender, EventArgs e)
        {
            resaltarboton(sender, JUPADICOLORS.color3);
            abrirformularios(new InicioRecepcionista());
        }
