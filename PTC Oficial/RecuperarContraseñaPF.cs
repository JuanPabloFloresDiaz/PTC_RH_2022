...
{
    public partial class RecuperarContraseñaPF : Form
    {
        //Campos
        private int borderRadius = 30;
        private int borderSize = 2;
        private Color borderColor = Color.Gray;
        public RecuperarContraseñaPF()
        {
            InitializeComponent();
        ...
        private void RecuperarContraseñaPF_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void RecuperarContraseñaPF_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void RecuperarContraseñaPF_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void RecuperarContraseñaPF_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void RecuperarContraseñaPF_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void RecuperarContraseñaPF_Load(object sender, EventArgs e)
        {
            VerificarPF verificar = new VerificarPF();
            cboPregunta.DataSource = verificar.preguntas();
            cboPregunta.DisplayMember = "pregunta";
            cboPregunta.ValueMember = "idPreguntas";
        }
    }
}
